...
function createSectionContent(section) {
  ...
  o = section.taboption(
    ...
    form.Flag,
    "fail_closed",
    _("Fail-closed protection"),
    _(
      "Protected traffic from this section never falls back to direct when the VPN/proxy is unavailable.",
    ) +
      " " +
      _(
        "If sing-box stops unexpectedly, nft and router DNS stay active so protected sites stay blocked until NetShift recovers.",
      ) +
      " " +
      _(
        "Requires NetShift-managed DNS; do not combine with \"Do not touch DHCP\".",
      ) +
      " " +
      _("Runtime outages may time out instead of instant reject."),
  );
  o.default = "0";
  o.rmempty = false;
  o.depends("connection_type", "proxy");
