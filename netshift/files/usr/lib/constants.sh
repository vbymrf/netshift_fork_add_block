...
NETSHIFT_RELEASE_API_URL="https://api.github.com/repos/vbymrf/netshift_fork_add_block/releases/latest"
...
NETSHIFT_REPO_RELEASES_LATEST_URL="https://github.com/vbymrf/netshift_fork_add_block/releases/latest"
NETSHIFT_REPO_RELEASES_DOWNLOAD_BASE="https://github.com/vbymrf/netshift_fork_add_block/releases/download"
...
SB_FAIL_CLOSED_REJECT_RULE_TAG="fail-closed-reject-rule-tag"
# Experimental
